...
function LoginPage() {
  ...
  const inputCls =
    "block h-[62px] w-full rounded-[11px] border border-[#E0E0DC] bg-white px-4 text-[16px] text-[#171717] shadow-[0_4px_14px_rgba(0,0,0,0.05)] outline-none transition-[border-color,box-shadow] duration-200 focus:border-[#C79A32] focus:shadow-[0_4px_14px_rgba(0,0,0,0.05),0_0_0_3px_rgba(199,154,50,0.12)]";
      ...
      <div className="flex items-center justify-center px-6 py-10 lg:py-6">
        <form onSubmit={submit} className="w-[min(470px,100%)]">
          <div className="flex flex-col items-center">
            <img src={symbolAsset.url} alt="" className="h-auto w-[170px] mix-blend-multiply sm:w-[200px] lg:w-[min(210px,22vh)]" />
            <div className="mt-2 whitespace-nowrap text-[28px] font-normal tracking-[0.32em] text-[#101010] sm:text-[34px] lg:text-[36px]">
              MILLION <span className="text-[#C39A39]">OS</span>
            </div>
          </div>
          <h2 className="mt-12 text-[36px] font-bold leading-tight text-[#171717] lg:mt-[min(56px,6vh)] lg:text-[40px]">Entrar</h2>
